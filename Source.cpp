...
bool checkIncresing(string file_name){
...
void writeToFile(int arr[],int n,string output_file){
...
void output(int size[],double result[][3]){
    cout << "\nResult:\n";
    ...
    while (true){
        ...
        for(int i = 0; i < 3; i++){
            for(int j = 0; j < 3; j++){
                ...
                if(checkIncresing("output.txt") == false){
                    cout << "Sort false " << n;
                    return 0; 
                }   
                delete[] arr; 
